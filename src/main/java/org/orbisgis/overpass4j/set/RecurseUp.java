 ...
 */
public class RecurseUp extends SubSet {

    private String inputSetAlias;

    public RecurseUp() {}

    public RecurseUp(String inputSetAlias) {
    ...
    public RecurseUp call(){
        return new RecurseUp();
    }

    public RecurseUp call(String inputSetAlias){
        return new RecurseUp(inputSetAlias);
    }
}
